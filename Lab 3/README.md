...
`duckdns.org` не работал, да и внешнего ip у меня нет. Попробую вместо своего доменного имени использовать `localhost`. Это же тоже своего рода доменное имя?)
...
Напишем плейбук который выполнит: 

* создаст файл ./test.txt с содержимым test_file_content

* изменит содержимое файла на другое

* выведет текущее содержимое файла
